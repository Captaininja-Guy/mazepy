...
(async function (){
    ...
    await pyodide.loadPackage("https://cdn.jsdelivr.net/gh/Captaininja-Guy/mazepy@main/dist/pyodide/the_maze_py-0.2.7-py3-none-any.whl");
    ...
    loader.animationPlayState = "paused";
    document.getElementById("type").disabled = false;
    document.getElementById("algo").disabled = false;
    document.getElementById("maze_size").disabled = false;
    document.getElementById("gen").disabled = false;
    document.getElementById("basecolor").disabled = false;
    document.getElementById("endcolor").disabled = false;
    document.getElementsByClassName("basecolortext")[0].style.opacity = "100%";
    document.getElementsByClassName("endcolortext")[0].style.opacity = "1000%";
...
var start_color;
var end_color;
async function create_animation(){
    ...
    await pyodide.runPythonAsync(`
        ...
        string = anim.to_jshtml(default_mode='once')
    `);
